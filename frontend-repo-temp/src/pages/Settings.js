...
const Settings = () => {
  ...
  const handleSettingChange = async (settingName, value) => {
    ...
    try {
      ...
      setSettingsError(err.response?.data?.msg || 'Error updating setting.');
    }
  };
    ...
    <>
      ...
      <Card className="shadow-sm">
        <Card.Body>
          ...
          <Button variant="secondary" className="me-2 mb-3" onClick={() => setShowPasswordModal(true)}>Change Password</Button>
          <hr />
